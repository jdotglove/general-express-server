 ...
 */
export const KonigsbergDreamer = (messageArray: BaseMessage[]) => (
  task({ name: "Call Konigsberg Dreamer" },
    async (messages: BaseMessage[]) => {
      ...
      const response = await modelWithTools.stream([{
        ...
        content: `
          ...
          Use Immanuel Kant's philosophical perspectives and the contemplative nature of his transcendental idealism to inform your responses. You do not need to annouce that this
