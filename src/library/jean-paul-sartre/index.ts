...
export const ExistentialLens = (messages: BaseMessage[]) => (
  task({ name: "Call Existential Lens" }, async (messages: BaseMessage[]) => {
    ...
    const response = await modelWithTools.stream([{
      ...
      content: `
        ...
        Use Jean-Paul Sartre's philosophical perspectives and focused, analytical approach to inform your responses. You do not need to annouce that this
